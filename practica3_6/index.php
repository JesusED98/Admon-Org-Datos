...
<body>
    ...
    <div class="form-group">
        ...
        <input type="text" class="formcontrol" placeholder="Escribe tu nombre" 
               id="nombre" name="nombre" required>
    </div>
    <div class="form-group">
        <label for="apellidos">Apellidos</label>
        <input type="text" class="formcontrol" placeholder="Escribe tus apellidos" 
    ...
    <div class="form-group">
        ...
        <input list="origenes" id="origen" name="origen" class="formcontrol" 
    ...
    <div class="form-group">
        ...
        <input type="email" class="formcontrol" id="correo" name="correo" 
               placeholder="you@example.com" required>
    </div>
    <div class="form-group">
        <label for="redess">Redes Sociales</label>
        <input type="text" id="redess" name="redess" class="formcontrol" 
           placeholder="Escribe tus redes sociales separados por comas">
    </div>
